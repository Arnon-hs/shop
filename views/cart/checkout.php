                        ...
                        <div class="col-sm-8 offset-md-2">
                            ...
                            <div class="login-form">
                                <form action="#" method="post">
                                    ...
                                    <p>Ваша фамилия</p>
                                    <input type="text" class="form-control" name="secondName" placeholder="Иванов" value="<?php echo $secondName; ?>"/>
                                    <p>Ваша имя</p>
                                    <input type="text" class="form-control" name="userName" placeholder="Иван" value="<?php echo $userName; ?>"/>
                                    <p>Ваше отчество</p>
                                    <input type="text" class="form-control" name="lastName" placeholder="Иванович" value="<?php echo $lastName; ?>"/>

                                    <p>Номер телефона</p>
                                    <input type="text" class="form-control" name="userPhone" placeholder="81234567890" value="<?php echo $userPhone; ?>"/>

                                    <p>Комментарий к заказу</p>
                                    <input type="text" class="form-control" name="userComment" placeholder="Сообщение" value="<?php echo $userComment; ?>"/>
