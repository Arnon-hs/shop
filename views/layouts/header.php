...
<div class="header d-flex justify-content-between pt-2 pb-2 container">
        <div class="logo icons"><a href="/"><img src="/template/images/product-details/logo.jpg"></a></div>
...
<div class="menu_header">
    <ul class="nav nav-tabs nav-fill menu_ul ">
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="http://shop/catalog" role="button" aria-haspopup="true" aria-expanded="false">Кофе</a>
            ...
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Чай</a>
                    <div class="dropdown-menu">
            ...
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Сладкое</a>
                    <div class="dropdown-menu">
            ...
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Аксессуары </a>
                    <div class="dropdown-menu">
                      <h5>Для чая</h5>
