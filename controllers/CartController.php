...
class CartController
{
    ...
    public function actionCheckout()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            // Валидация полей
            $errors = false;
            if (!User::checkName($userName,$lastName,$secondName))
            ...
            if ($errors == false) {
                ...
                $result = Order::save($userName,$lastName,$secondName, $userPhone, $userComment, $userId, $productsInCart);

                if ($result) {
                    // Оповещаем администратора о новом заказе                
                    $adminEmail = 'anyaflorist2019@mail.ru';
                    $message = 'Сообщение';
                    $subject = 'Новый заказ!';
